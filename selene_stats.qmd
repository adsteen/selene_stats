...
```{r, plot=TRUE, echo=FALSE, fig.height=7, fig.width=7}
cowplot::plot_grid(p_region, p_path,
                   raw_line_plot(raw_region_data), raw_line_plot(raw_path_data),
                   raw_bar_plot(raw_region_data), raw_bar_plot(raw_path_data),
                   nrow=3)
```
